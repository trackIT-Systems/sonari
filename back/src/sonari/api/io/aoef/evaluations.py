...
from sonari.api.io.aoef.clip_annotations import get_clip_annotations
from sonari.api.io.aoef.clip_evaluations import get_clip_evaluations
from sonari.api.io.aoef.clip_predictions import get_clip_predictions
from sonari.api.io.aoef.clips import get_clips
from sonari.api.io.aoef.features import (
    get_feature_names,
    import_feature_names,
)
from sonari.api.io.aoef.recordings import get_recordings
from sonari.api.io.aoef.sound_event_annotations import (
    get_sound_event_annotations,
)
from sonari.api.io.aoef.sound_event_evaluations import (
    get_sound_event_evaluations,
)
from sonari.api.io.aoef.sound_event_predictions import (
    get_sound_event_predictions,
)
from sonari.api.io.aoef.sound_events import get_sound_events
from sonari.api.io.aoef.tags import import_tags
from sonari.api.io.aoef.users import import_users
...
async def add_evaluation_metrics(
    ...
    missing = [v for v in values if (v["feature_name_id"], v["evaluation_id"]) not in existing]
    if not missing:
        return
