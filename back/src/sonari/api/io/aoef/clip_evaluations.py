...
async def _create_clip_evaluations(
    ...
    missing = [
        ...
        for clip_evals, eval_uuid in zip(clip_evaluations, evaluations_uuids, strict=False)
...
async def _create_clip_evaluation_metrics(
    ...
    missing = [v for v in values if (v["clip_evaluation_id"], v["feature_name_id"]) not in existing]
