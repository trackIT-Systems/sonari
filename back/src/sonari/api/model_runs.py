...
from sonari.api.common import BaseAPI, create_object
from sonari.filters.base import Filter
from sonari.filters.clip_predictions import ModelRunFilter
...
class ModelRunAPI(
    ...
    async def from_soundevent(self, session: AsyncSession, data: data.ModelRun) -> schemas.ModelRun:
        try:
    ...
    async def to_soundevent(
        ...
        predictions, _ = await self.get_clip_predictions(session, obj, limit=-1)
