...
from sonari.filters.sound_event_evaluations import ClipEvaluationFilter
...
class ClipEvaluationAPI(
    ...
    async def add_metric(
        ...
        for m in obj.metrics:
            if m.name == metric.name:
                raise ValueError(f"Clip evaluation {obj.id} already has a metric " f"with feature name {metric.name}.")
    ...
    async def update_metric(
        ...
        for m in obj.metrics:
            ...
            raise ValueError(f"Clip evaluation {obj.id} does not have a metric " f"with feature name {metric.name}.")
    ...
    async def from_soundevent(
        ...
        -------
        schemas.ClipEvaluation
            The clip evaluation in sonari format.
        """
    ...
    async def to_soundevent(
        ...
        """Create a clip evaluation in soundevent format from a clip evaluation in sonari format.
