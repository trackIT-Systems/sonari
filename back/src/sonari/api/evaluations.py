...
from sonari.filters.clip_evaluations import EvaluationFilter
...
class EvaluationAPI(
    ...
    async def add_metric(
        ...
        for m in obj.metrics:
            if m.name == metric.name:
                raise ValueError(f"Evaluation {obj.id} already has a metric " f"with feature name {metric.name}.")
    ...
    async def remove_metric(
        ...
        for m in obj.metrics:
            ...
            raise ValueError(f"Evaluation {obj.id} does not have a metric " f"with feature name {metric.name}.")
