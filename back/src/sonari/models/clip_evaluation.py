...
from sonari.models.clip_prediction import ClipPrediction
from sonari.models.feature import FeatureName
from sonari.models.sound_event_evaluation import SoundEventEvaluation

if TYPE_CHECKING:
    from sonari.models.evaluation import Evaluation
