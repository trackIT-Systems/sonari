...
from sonari.system.data import get_sonari_db_file, get_sonari_settings_file
...
class Settings(BaseSettings):
    ...
    """Number of workers to parallelize sonari.
...
def load_settings_from_file() -> Settings:
    ...
    settings_file = get_sonari_settings_file()
...
def store_default_settings() -> None:
    ...
    default_settings = Settings(
        db_name=str(get_sonari_db_file()),
    )
