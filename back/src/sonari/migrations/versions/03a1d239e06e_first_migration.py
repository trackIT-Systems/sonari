...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("uuid", fastapi_users_db_sqlalchemy.generics.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("audio_dir", sonari.models.base.PathType(), nullable=False),
        sa.Column("created_on", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("path", sonari.models.base.PathType(), nullable=False),
    ...
    op.create_index(op.f("ix_recording_hash"), "recording", ["hash"], unique=True)
    op.create_index(op.f("ix_recording_path"), "recording", ["path"], unique=True)
    op.create_table(
        "tag",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("dataset_id", "recording_id", name=op.f("pk_dataset_recording")),
        sa.UniqueConstraint(
            "dataset_id",
            "recording_id",
            "path",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_evaluation_set_model_run_evaluation_set_id_evaluation_set"),
        ),
        sa.ForeignKeyConstraint(
            ["model_run_id"],
            ["model_run.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_evaluation_set_tag_evaluation_set_id_evaluation_set"),
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"],
            ["tag.id"],
        ...
        sa.PrimaryKeyConstraint("evaluation_set_id", "tag_id", name=op.f("pk_evaluation_set_tag")),
        sa.UniqueConstraint(
            "evaluation_set_id",
            "tag_id",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_model_run_evaluation_evaluation_set_id_evaluation_set"),
        ),
        sa.ForeignKeyConstraint(
            ["model_run_id"],
            ["model_run.id"],
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("recording_id", "user_id", name=op.f("pk_recording_owner")),
        sa.UniqueConstraint(
            "recording_id",
            "user_id",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tag_id"], ["tag.id"], name=op.f("fk_recording_tag_tag_id_tag")),
        sa.PrimaryKeyConstraint("recording_id", "tag_id", name=op.f("pk_recording_tag")),
        sa.UniqueConstraint(
            "recording_id",
            "tag_id",
    ...
    op.create_table(
        ...
        sa.Column("geometry", sonari.models.base.GeometryType(), nullable=False),
        sa.Column("created_on", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["recording_id"],
            ["recording.id"],
    ...
    op.create_table(
        ...
        sa.Column("created_on", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["user_id"], ["user.id"], name=op.f("fk_user_run_user_id_user")),
    ...
    op.create_table(
        ...
        sa.Column("value", sa.Float(), nullable=False),
        sa.Column("created_on", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["clip_id"], ["clip.id"], name=op.f("fk_clip_feature_clip_id_clip")),
        sa.ForeignKeyConstraint(
            ["feature_name_id"],
            ["feature_name.id"],
            name=op.f("fk_clip_feature_feature_name_id_feature_name"),
        ),
        sa.PrimaryKeyConstraint("clip_id", "feature_name_id", name=op.f("pk_clip_feature")),
        sa.UniqueConstraint("clip_id", "feature_name_id", name=op.f("uq_clip_feature_clip_id")),
    )
    op.create_table(
        "clip_prediction",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_evaluation_set_user_run_evaluation_set_id_evaluation_set"),
        ),
        sa.ForeignKeyConstraint(
            ["user_run_id"],
            ["user_run.id"],
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("recording_id", "note_id", name=op.f("pk_recording_note")),
        sa.UniqueConstraint(
            "recording_id",
            "note_id",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_user_run_evaluation_evaluation_set_id_evaluation_set"),
        ),
        sa.ForeignKeyConstraint(
            ["user_run_id"],
            ["user_run.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["annotation_project_id"],
            ["annotation_project.id"],
            name=op.f("fk_annotation_task_annotation_project_id_annotation_project"),
        ),
        sa.ForeignKeyConstraint(
            ["clip_annotation_id"],
            ["clip_annotation.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_annotation_id"],
            ["clip_annotation.id"],
            name=op.f("fk_clip_annotation_note_clip_annotation_id_clip_annotation"),
        ),
        sa.ForeignKeyConstraint(
            ["note_id"],
            ["note.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_annotation_id"],
            ["clip_annotation.id"],
            name=op.f("fk_clip_annotation_tag_clip_annotation_id_clip_annotation"),
        ),
        sa.ForeignKeyConstraint(
            ["created_by_id"],
            ["user.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_prediction_id"],
            ["clip_prediction.id"],
            name=op.f("fk_clip_prediction_tag_clip_prediction_id_clip_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"],
            ["tag.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_annotation_id"],
            ["clip_annotation.id"],
            name=op.f("fk_evaluation_set_annotation_clip_annotation_id_clip_annotation"),
        ),
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_set.id"],
            name=op.f("fk_evaluation_set_annotation_evaluation_set_id_evaluation_set"),
        ),
        sa.PrimaryKeyConstraint(
            "evaluation_set_id",
            "clip_annotation_id",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_prediction_id"],
            ["clip_prediction.id"],
            name=op.f("fk_model_run_prediction_clip_prediction_id_clip_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["model_run_id"],
            ["model_run.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_annotation_id"],
            ["clip_annotation.id"],
            name=op.f("fk_sound_event_annotation_clip_annotation_id_clip_annotation"),
        ),
        sa.ForeignKeyConstraint(
            ["created_by_id"],
            ["user.id"],
        ...
        sa.UniqueConstraint("uuid", name=op.f("uq_sound_event_annotation_uuid")),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_prediction_id"],
            ["clip_prediction.id"],
            name=op.f("fk_sound_event_prediction_clip_prediction_id_clip_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["sound_event_id"],
            ["sound_event.id"],
        ...
        sa.UniqueConstraint("uuid", name=op.f("uq_sound_event_prediction_uuid")),
    )
    op.create_table(
        "user_run_prediction",
        sa.Column("user_run_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["clip_prediction_id"],
            ["clip_prediction.id"],
            name=op.f("fk_user_run_prediction_clip_prediction_id_clip_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["user_run_id"],
            ["user_run.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["annotation_task_id"],
            ["annotation_task.id"],
            name=op.f("fk_annotation_status_badge_annotation_task_id_annotation_task"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_evaluation_id"],
            ["clip_evaluation.id"],
            name=op.f("fk_clip_evaluation_metric_clip_evaluation_id_clip_evaluation"),
        ),
        sa.ForeignKeyConstraint(
            ["feature_name_id"],
            ["feature_name.id"],
            name=op.f("fk_clip_evaluation_metric_feature_name_id_feature_name"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_sound_event_annotation_note_sound_event_annotation_id_sound_event_annotation"),
        ),
        sa.PrimaryKeyConstraint(
            "sound_event_annotation_id",
            "note_id",
        ...
        sa.UniqueConstraint(
            "sound_event_annotation_id",
            "note_id",
            name=op.f("uq_sound_event_annotation_note_sound_event_annotation_id"),
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sound_event_annotation_id"],
            ["sound_event_annotation.id"],
            name=op.f("fk_sound_event_annotation_tag_sound_event_annotation_id_sound_event_annotation"),
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"],
            ["tag.id"],
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_sound_event_annotation_tag")),
        sa.UniqueConstraint(
            "sound_event_annotation_id",
            "tag_id",
            "created_by_id",
            name=op.f("uq_sound_event_annotation_tag_sound_event_annotation_id"),
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clip_evaluation_id"],
            ["clip_evaluation.id"],
            name=op.f("fk_sound_event_evaluation_clip_evaluation_id_clip_evaluation"),
        ),
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["sound_event_prediction.id"],
            name=op.f("fk_sound_event_evaluation_source_id_sound_event_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["target_id"],
            ["sound_event_annotation.id"],
            name=op.f("fk_sound_event_evaluation_target_id_sound_event_annotation"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_sound_event_evaluation")),
        sa.UniqueConstraint("uuid", name=op.f("uq_sound_event_evaluation_uuid")),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["sound_event_prediction.id"],
            name=op.f("fk_sound_event_prediction_tag_sound_event_prediction_id_sound_event_prediction"),
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"],
            ["tag.id"],
        ...
        sa.UniqueConstraint(
            "sound_event_prediction_id",
            "tag_id",
            name=op.f("uq_sound_event_prediction_tag_sound_event_prediction_id"),
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["feature_name_id"],
            ["feature_name.id"],
            name=op.f("fk_sound_event_evaluation_metric_feature_name_id_feature_name"),
        ),
        sa.ForeignKeyConstraint(
            ["sound_event_evaluation_id"],
            ["sound_event_evaluation.id"],
            name=op.f("fk_sound_event_evaluation_metric_sound_event_evaluation_id_sound_event_evaluation"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_sound_event_evaluation_metric")),
        sa.UniqueConstraint(
            "sound_event_evaluation_id",
            "feature_name_id",
            name=op.f("uq_sound_event_evaluation_metric_sound_event_evaluation_id"),
        ),
    )
