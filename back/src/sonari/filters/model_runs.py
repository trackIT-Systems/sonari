...
SearchFilter = base.search_filter([models.ModelRun.name, models.ModelRun.version])
...
class ScoreFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        query = (
            ...
            .join(
                models.Evaluation,
                models.Evaluation.id == models.ModelRunEvaluation.evaluation_id,
            )
    ...
    def filter(self, query: Select) -> Select:
        ...
        return (
            ...
            .join(
                ...
                models.EvaluationSet.id == models.EvaluationSetModelRun.evaluation_set_id,
            )
