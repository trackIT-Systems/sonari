    ...
    def filter(self, query: Select) -> Select:
        ...
        return (
            query.join(
                ...
                models.ModelRunEvaluation.evaluation_id == models.Evaluation.id,
            )
            .join(
                models.ModelRun,
    ...
    def filter(self, query: Select) -> Select:
        ...
        subquery1 = (
            ...
            .join(
                ...
                models.EvaluationSet.id == models.ModelRunEvaluation.evaluation_set_id,
            )
        ...
        subquery2 = (
            ...
            .join(
                models.EvaluationSet,
                models.EvaluationSet.id == models.UserRunEvaluation.evaluation_set_id,
            )
            .filter(models.EvaluationSet.uuid == self.eq)
        )
