...
class ClipAnnotationFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.ClipAnnotation.id == models.ClipEvaluation.clip_annotation_id,
...
class ClipPredictionFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.ClipPrediction.id == models.ClipEvaluation.clip_prediction_id,
...
class MetricFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        query = query.join(
            ...
            models.ClipEvaluationMetric.clip_evaluation_id == models.ClipEvaluation.id,
        ).join(
            models.FeatureName,
            models.FeatureName.id == models.ClipEvaluationMetric.feature_name_id,
        )
    ...
    def filter(self, query: Select) -> Select:
        ...
        query = (
            ...
            .join(
                ...
                models.ClipAnnotationTag.clip_annotation_id == models.ClipAnnotation.id,
            )
            .join(
                models.Tag,
