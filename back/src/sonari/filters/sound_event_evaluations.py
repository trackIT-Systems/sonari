...
class ClipEvaluationFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.ClipEvaluation.id == models.SoundEventEvaluation.clip_evaluation_id,
...
class TargetFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.SoundEventAnnotation.id == models.SoundEventEvaluation.target_id,
...
class SourceFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.SoundEventPrediction.id == models.SoundEventEvaluation.source_id,
...
class MetricFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        query = query.join(
            ...
            models.SoundEventEvaluationMetric.sound_event_evaluation_id == models.SoundEventEvaluation.id,
        ).join(
            models.FeatureName,
            models.FeatureName.id == models.SoundEventEvaluationMetric.feature_name_id,
        )
...
class HasSourceFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.filter(models.SoundEventEvaluation.source_id.isnot(None) == self.eq)
...
class HasTargetFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.filter(models.SoundEventEvaluation.target_id.isnot(None) == self.eq)
    ...
    def filter(self, query: Select) -> Select:
        ...
        query = (
            ...
            .join(
                ...
                models.SoundEventPredictionTag.sound_event_prediction_id == models.SoundEventPrediction.id,
            )
            .join(
                models.Tag,
