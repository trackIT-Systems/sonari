...
class ClipPredictionFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        return query.join(
            ...
            models.ClipPrediction.id == models.SoundEventPrediction.clip_prediction_id,
...
class TagFilter(base.Filter):
    ...
    def filter(self, query: Select) -> Select:
        ...
        ).join(models.Tag, models.Tag.id == models.SoundEventPredictionTag.tag_id)
        ...
        return query.join(models.SoundEventPredictionTag).where(and_(*conditions))
    ...
    def filter(self, query: Select) -> Select:
        ...
        return (
            ...
            .join(
                ...
                models.ModelRunPrediction.clip_prediction_id == models.ClipPrediction.id,
            )
            .join(
                models.ModelRun,
    ...
    def filter(self, query: Select) -> Select:
        ...
        return (
            ...
            .join(
                ...
                models.UserRunPrediction.clip_prediction_id == models.ClipPrediction.id,
            )
            .join(
                models.UserRun,
